...
export const ROLES: Record<TeamRole, RoleDef> = {
  ...
  editora: {
    ...
    home: "/edicion",
    routes: ["/edicion", "/videos", "/estudio", "/cover", "/transcriptor", "/drive", "/biblioteca", "/mis-tareas", "/agencia", ...COMMON_ROUTES],
    canManageTeam: false,
  ...
  social: {
    ...
    home: "/redes",
    routes: ["/redes", "/", "/schedule", "/cuentas", "/videos", "/historias", "/descripciones", "/insights", "/biblioteca", "/campanas", "/mis-tareas", "/agencia", ...COMMON_ROUTES],
    canManageTeam: false,
    canManagePeople: false,
    canAssignGoals: false,
    canReview: false,
  ...
  ventas: {
    ...
    home: "/ejecutivo",
    routes: ["/ejecutivo", "/proyecciones", "/agencia", ...COMMON_ROUTES],
    canManageTeam: false,
    canManagePeople: false,
    canAssignGoals: true,
    canReview: false,
  ...
  dev: {
    ...
    home: "/mis-tareas",
    routes: ["/mis-tareas", "/ejecutivo", "/drive", "/agencia", ...COMMON_ROUTES],
    canManageTeam: false,
    canManagePeople: false,
    canAssignGoals: false,
    canReview: false,
  ...
  marketing: {
    ...
    home: "/marketing",
    routes: ["/marketing", "/", "/insights", "/schedule", "/biblioteca", "/campanas", "/videos", "/historias", "/descripciones", "/cuentas", "/mis-tareas", "/agencia", ...COMMON_ROUTES],
    canManageTeam: false,
    canManagePeople: false,
    canAssignGoals: false,
    canReview: true,
