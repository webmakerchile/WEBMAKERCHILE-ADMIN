...
const [TITLE, SUBTITLE] = TAB_TITLES.ventas;

export default function VentasPage() {
  const hub = useHubBoard("ventas");
    ...
    <Layout>
      <div className="hub-root relative">
        ...
        <div className="main">
          {hub.canManageSvc ? (
            <div className="wrap">
              <VentasPanel showToast={hub.showToast} />
            </div>
          ) : (
            <div className="wrap">
              <EmptyState
                title="Sin acceso a Ventas"
                hint="El pipeline de ventas y renovaciones lo gestiona dirección y el equipo de ventas."
                icon={<Lock />}
              />
            </div>
          )}
