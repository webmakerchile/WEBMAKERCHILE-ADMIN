...
import { ContractsView } from "./hub/views/contracts-view";
...
const [TITLE, SUBTITLE] = TAB_TITLES.contracts;

export default function ContratosPage() {
  const hub = useHubBoard("contracts");
  const onNew = hub.newAction("contracts", { kind: "new-contract-mode" });
  ...
  return (
    <Layout>
      <div className="hub-root relative">
        ...
        <div className="main">
          <ContractsView state={hub.state} onOpen={id => hub.openSheet({ kind: "contract", id })} onNew={onNew} />
        </div>
