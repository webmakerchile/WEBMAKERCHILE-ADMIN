...
import { TeamView } from "./hub/views/team-view";
...
const [TITLE, SUBTITLE] = TAB_TITLES.team;

export default function EquipoHoyPage() {
  const hub = useHubBoard("team");
