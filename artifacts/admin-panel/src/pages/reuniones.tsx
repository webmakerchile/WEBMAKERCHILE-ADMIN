...
import { MeetView } from "./hub/views/meet-view";
...
const [TITLE, SUBTITLE] = TAB_TITLES.meet;

export default function ReunionesPage() {
  const hub = useHubBoard("meet");
  const onNew = hub.newAction("meetings", { kind: "new-meet" });
  ...
  return (
    <Layout>
      <div className="hub-root relative">
        ...
        <div className="main">
          <MeetView state={hub.state} onOpen={id => hub.openSheet({ kind: "meet", id })} />
        </div>
