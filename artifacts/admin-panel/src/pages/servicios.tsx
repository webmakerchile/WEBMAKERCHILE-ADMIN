...
import { SvcView } from "./hub/views/svc-view";
...
const [TITLE, SUBTITLE] = TAB_TITLES.svc;

export default function ServiciosPage() {
  const hub = useHubBoard("svc");
  ...
  return (
    <Layout>
      <div className="hub-root relative">
        ...
        <div className="main">
          {hub.canSeeSvc ? (
            <SvcView canManage={hub.canManageSvc} showToast={hub.showToast} />
          ) : (
            <div className="wrap">
              <EmptyState
                title="Sin acceso a Servicios"
                hint="El catálogo de referencia lo gestiona dirección y el equipo de ventas."
                icon={<Lock />}
              />
            </div>
          )}
