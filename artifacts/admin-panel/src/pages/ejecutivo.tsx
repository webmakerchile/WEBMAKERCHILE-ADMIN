...
export default function EjecutivoPage() {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 50, overflow: "hidden" }}>
      ...
      {/* ---- BACK BUTTON ---- */}
      <button onClick={() => setLocation("/")} title="Volver al panel"
        style={{ position:"fixed", bottom:"1.5rem", right:"1.5rem", zIndex:200, background:"rgba(0,0,0,0.82)", backdropFilter:"blur(12px)", WebkitBackdropFilter:"blur(12px)", display:"flex", alignItems:"center", gap:"0.5rem", padding:"0.5rem 0.875rem", borderRadius:"0.75rem", color:"white", fontSize:"0.8125rem", fontWeight:500, border:"1px solid rgba(255,255,255,0.12)", cursor:"pointer", boxShadow:"0 8px 24px rgba(0,0,0,0.5)", fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif" }}
