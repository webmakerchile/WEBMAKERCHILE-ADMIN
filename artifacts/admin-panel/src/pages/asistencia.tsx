...
import { AttendanceView } from "./hub/views/attendance-view";
...
const [TITLE, SUBTITLE] = TAB_TITLES.att;

export default function AsistenciaPage() {
  const hub = useHubBoard("att");
      ...
      <div className="hub-root relative">
        ...
        <div className="main">
          {hub.canSeeAtt ? (
            ...
            <div className="wrap">
              <EmptyState
                title="Sin acceso a Asistencia"
                hint="El registro de jornada del equipo lo gestiona dirección."
                icon={<Lock />}
              />
            </div>
          )}
