...
const [TITLE, SUBTITLE] = TAB_TITLES.cobros;

export default function CobrosPage() {
  const hub = useHubBoard("cobros");
    ...
    <Layout>
      <div className="hub-root relative">
        ...
        <div className="main">
          {hub.canManageSvc ? (
            <div className="wrap">
              <CobrosPanel showToast={hub.showToast} />
            </div>
          ) : (
            <div className="wrap">
              <EmptyState
                title="Sin acceso a Cobros"
                hint="La caja de proyectos activos y pagos recibidos la gestiona dirección y el equipo de ventas."
                icon={<Lock />}
              />
            </div>
          )}
