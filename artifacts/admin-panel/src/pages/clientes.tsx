...
import { ClientsView } from "./hub/views/clients-view";
...
const [TITLE, SUBTITLE] = TAB_TITLES.clients;

export default function ClientesPage() {
  const hub = useHubBoard("clients");
  const [searchQ, setSearchQ] = useState("");
  const onNew = hub.newAction("clients", { kind: "new-client" });
  ...
  return (
    <Layout>
      <div className="hub-root relative">
        ...
        <div className="main">
          <ClientsView state={hub.state} onOpen={id => hub.openSheet({ kind: "client", id })} searchQ={searchQ} setSearchQ={setSearchQ} />
        </div>
