      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-sm leading-relaxed text-muted-foreground">
          <section>
            ...
            <p>
              <strong className="text-foreground">WebMaker Latam</strong> ("WebMaker Latam", "el Servicio", "nosotros" o "nuestro") es la plataforma de gestión de contenido disponible en admin.webmakerlatam.com. Esta Política de Privacidad explica cómo WebMaker Latam recopila, usa, almacena y protege su información personal.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Para consultas sobre esta Política de Privacidad o para ejercer sus derechos, contacte a: <a href="mailto:webmakerlatam@gmail.com" className="text-primary hover:underline">webmakerlatam@gmail.com</a>
            </p>
          </section>
        </div>
