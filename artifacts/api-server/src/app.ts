...
app.use(/^\/api\/(library\/templates\/ai-fill|content\/videos\/[^/]+\/(generate-descriptions|generate-cover)|content\/videos\/bulk-generate-descriptions|analytics\/insights|content\/hashtag-suggestions|gemini\/conversations\/[^/]+\/messages|gemini\/generate-image|gemini\/generate-cover|gemini\/improve-cover-idea|studio\/ideas\/(generate|[^/]+\/generate-cover)|community\/(sorprendeme|historias\/(generar|detectar-formato|reintentar)|descripciones\/(generar|calcular-slides|reintentar-slide))|hub\/contracts\/(extract-pdf|extract-from-meeting|ai-chat|brief|ai-extract-project)|hub\/projects\/ai-extract-tasks|cotizaciones\/generar)/, aiLimiter);
