...
- [DB migrations workflow](db-migrations-workflow.md) — drizzle push hangs on interactive prompts; apply DDL via SQL, mirror it in a numbered lib/db/drizzle file, prod is migrated manually at publish.
