...
- `hub_work_sessions` - Sesiones de jornada del equipo (check-in/out, día local Santiago en `work_date`, flag `on_discord`; índice único parcial: máx. 1 sesión abierta por usuario)
